...
document.getElementById('city-idResultsBtn').addEventListener('click', () => {
    ...
    document.getElementById('displayResults').classList.remove('hide-show');
    document.getElementById('displayDate').innerHTML = 'On date: ' + dateInput.value;
...
document.getElementById('coordsResultBtn').addEventListener('click', () => {
    ...
    document.getElementById('displayResults').classList.remove('hide-show');
    document.getElementById('displayDate').innerHTML = 'On date: ' + dateInput;
...
var coordsPage = document.getElementById('coords-page');
var chooseValue = document.getElementById('choose-value');
var cityIdZip = document.getElementById('cityIdZip');
nextStep.addEventListener('click', onClick);
function onClick() {
    if (dropList.value === 'city' || dropList.value === 'id' || dropList.value === 'ZIP') {
        chooseValue.classList.add('hide-show');
        cityIdZip.classList.remove('hide-show');

    }
    else if
        (dropList.value === 'coord') {
        chooseValue.classList.add('hide-show');
